<template>
    ...
    <section class="content">
        ...
        <!-- /.box-footer-->
            ...
            <div class="modal modal-primary" tabindex="-1" :class="{'mostrar' : modal}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                <div class="modal-dialog " role="document">
                  ...
                  <span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-outline" @click="registrarPersona()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2" class="btn btn-outline" @click="actualizarPersona()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if (!this.nombre) this.errorMostrarMsjPersona.push("El nombre de la persona es obligatorio.");
