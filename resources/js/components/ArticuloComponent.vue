                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    <td>
                                        <button type="button" @click="abrirModal('articulo','actualizar',articulo)" class="btn btn-primary btn-sm" title="Editar">
                                          <i class="fa fa-pencil"></i>
                                        </button> 
                                        <template v-if="articulo.condicion">
                                            <button type="button" class="btn btn-warning btn-sm" @click="desactivarArticulo(articulo.id)" title="Desactivar">
                                        ...
                                        &nbsp;<button type="button" class="btn btn-danger btn-sm" @click="eliminarArticulo(articulo.id)" title="Eliminar">
            ...
            <div class="modal" tabindex="-1" :class="{'mostrar' : modal}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                ...
                <h4 class="modal-title"  v-text="tituloModal"></h4>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1"  class="btn btn-outline" @click="registrarArticulo()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2"  class="btn btn-outline" @click="actualizarArticulo()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
